        ...
        <Row>
          ...
          <Col sm={12} md={6} lg={6} className='text-center'>
            <div className='w-100'>
              ...
              <img src='/foro-electromovilidad/FernandoAranda.webp' alt='fernando-aranda' className='pb-4' style={{ width: '300px' }} />
              <h3>Fernando Aranda</h3>
              <h5>Manager Foro Electromovilidad y Semiconductores</h5>
