...
const emailLayout2 = async (formData, qrcode) => {
  const qrCodeUrl = `https://hfmexico.mx/foro-nearshoring/verify/${qrcode}`
                ...
                <div style="background: black;color: white;border-radius: 20px;">
                  <div style="background: radial-gradient(75.53% 100.65% at 50% 145.96%,rgba(83, 71, 255, 0.5),rgba(87,205,255,0) 100%);padding: 20px;">                   
                    ...
                    <div  style="text-align: center;">
                      <h2 style="margin:0;">¡Foro Nearshoring!</h2>
                       5 de octubre de 2023 13:30 HRS.
                    </div>
                  </div>
                </div>
              </td>              
          ...
          <tbody>
            <tr>
              <td>
                ...
                <ul>
                  <li>
                    Foro Nearshoring se lanzará el 5 de octubre a las 13:30 HRS.
                  </li>
                  <li>
