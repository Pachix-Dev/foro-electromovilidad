...
const emailLayout = async (formData, qrcode) => {
  const qrCodeUrl = `https://igego.com.mx/foro-electromovilidad/backend/verify.php?qr=${qrcode}`
          ...
          <tbody style="width: 100%;">
            <tr style="width: 100%;">
              <td style="padding: 20px 30px 15px;">
                <h1 style="color: rgb(255, 255, 255); font-size: 27px; font-weight: bold; line-height: 27px;">Hello , ${formData.nombre}</h1>
              ...
              <td style="padding: 30px 10px;">
                <img src="${qrCodeImage}" width="240" style="display: block; outline: none; border: none; text-decoration: none;">
              </td>
            </tr>
          </tbody>
        </table>
